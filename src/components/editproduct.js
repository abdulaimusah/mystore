...
const EditProductForm = ({
	...
	const handleSubmit = (e) => {
		...
		fetch(
			`https://mystore-backend-1xri.onrender.com/update/${editproduct._id}`,
			{
				method: "PUT",
				headers: {
	...
	return (
		<div>
			<h1 className="font-bold text-lg mt-8 mb-8 text-center">Edit Product</h1>
      ...
      text-medium"
			...
			<form
				...
				className="max-w-md mt-4 mx-auto mb-12"
			>
				<div className="mb-4">
					<label
						htmlFor="name"
